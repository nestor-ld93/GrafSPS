...
echo ""
echo "+==========================================================================+"
echo "|                      SISMICIDAD-PERFILES v1.0.0                          |"
echo "+==========================================================================+"
...
set perfil_norte  = $28     # Variables: 'si', 'no' (Graficar el area del perfil, no graficar).
set perfil_centro = $29     # Variables: 'si', 'no' (Graficar el area y corte del perfil, no graficar).
set perfil_sur    = $30     # Variables: 'si', 'no' (Graficar el area y corte del perfil, no graficar).
